...
UA = "GridSight-UK-v4.0-morphology-acquisition/1.1 (+https://github.com/xm2325/gridsight_uk)"

# Pre-existing geographically diverse Geograph seed records not used in the closed v2-v3 component
# model-selection/final-holdout cycle. Selection here is metadata/geography only; no model scores are used.
# The pool is intentionally expanded before any v4 model inference so the v4 split can be frozen on
# pixel-level morphology/annotatability rather than on model behaviour.
CANDIDATES = [
    ...
    {"photo_id":"4451265","country":"Wales","photographer":"Matt Harrop","direct_url":"https://s0.geograph.org.uk/geophotos/04/45/12/4451265_143b7227.jpg"},
    ...
    {"photo_id":"4712773","country":"England","photographer":"David Smith","direct_url":None},
    {"photo_id":"8239540","country":"England","photographer":"N Chadwick","direct_url":None},
    {"photo_id":"543992","country":"England","photographer":"Andrew Whale","direct_url":None},
    ...
    {"photo_id":"1352733","country":"England","photographer":"Chris Downer","direct_url":None},
    {"photo_id":"8261555","country":"England","photographer":"Neil Owen","direct_url":None}
]
...
def main():
    ...
    report={
      ...
      "status":"PASS","count":len(rows),"selection_basis":"pre-existing geographically diverse Geograph seed queue; old v2-v3 train/val/development/final sources excluded from candidate-role selection; no model outputs used",
