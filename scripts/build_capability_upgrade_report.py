...
<section class="panel warning"><strong>This is not yet the supplied Keen AI result.</strong><p>The page keeps deployment gaps visible. The new prospective UK localisation audit found only __LOC_TILE_TP__/40 targets with fixed EPRI tiling; proposal fusion reached __LOC_FUSION_TP__/40 but produced __LOC_FUSION_FP__ false positives. TTPLA steel structure is a transmission-tower assembly task, and the pole-top benchmark is a publisher-mask-derived shaft endpoint rather than a physical component detector.</p><a href="../index.html">← UK review workbench</a> · <a href="../material_prospective/index.html">UK material audit</a> · <a href="../localisation_prospective/index.html">UK localisation audit</a> · <a href="http://127.0.0.1:8771/report/index.html">EPRI component explorer ↗</a></section>
<section class="cards"><div class="card"><small>UK localisation · prospective</small><strong>__LOC_TILE_TP__ / 40</strong><p>Fixed EPRI full+tile true positives with zero false positives. Fusion reached __LOC_FUSION_TP__/40 with __LOC_FUSION_FP__ false positives. <a href="../localisation_prospective/index.html">Inspect all eight images</a>.</p></div><div class="card"><small>UK material · prospective oracle regions</small><strong>__MAT_CORRECT__ / __MAT_ACCEPTED__</strong><p>__MAT_ACC__ accepted accuracy at __MAT_COVERAGE__ coverage across __MAT_TOTAL__ source-assisted regions. Full-image localisation matched __LOC_MATCHED__/__MAT_TOTAL__. <a href="../material_prospective/index.html">Inspect all five assets</a>.</p></div><div class="card"><small>Lattice steel structure · fixed test</small><strong>__STEEL_TP__ / __STEEL_TOTAL__</strong><p>Supervised matched instances; open vocabulary matched __OPEN_TP__/__STEEL_TOTAL__. Both had zero detections on __STEEL_NEG__ hard-negative images at score 0.25.</p></div><div class="card"><small>Pole-shaft endpoint · development</small><strong>__POLE_ACCEPTED__ / __POLE_ELIGIBLE__</strong><p>Mask geometry coverage versus __BOX_ACCEPTED__/__POLE_ELIGIBLE__ for box geometry. Accepted mask outputs had median normalised error __POLE_MEDIAN__.</p></div></section>
